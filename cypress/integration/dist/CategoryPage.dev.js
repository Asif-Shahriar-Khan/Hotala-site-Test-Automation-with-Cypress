...
describe('Hotala Test', function () {
  ...
  it.only('Go to a Category page from Homepage property tiles', function () {
    ...
    cy.wait(2000);
    cy.get('#north-america > :nth-child(1) > a > .details').click({
      force: true
    });
    cy.wait(2000);
    cy.get('#js-date-picker-close > .icon').click({
      force: true
    });
    cy.wait(2000);
  });
  ...
  it('Go to property details page by clicking title', function () {
    cy.get('#js-BC-236937-details-btn-anchor').click({
      force: true
    });
    cy.wait(4000);
    cy.go('back');
  ...
  it('Click on See more properties of this section', function () {
    ...
    cy.wait(2000);
    cy.get('#see-all-offer-section-0').click({
      force: true
    });
    cy.wait(6000);
    cy.go('back');
  ...
  it('Go to property details page by clicking title', function () {
    cy.get('#js-section-1 > .see-more-properties > h2').scrollIntoView();
    cy.get('#js-BC-236345-details-btn-anchor').click({
      force: true
    });
    cy.wait(2000);
    cy.go('back');
  ...
  it('Click on See more properties of this 5 Star Hotels section', function () {
    ...
    cy.wait(2000);
    cy.get('#see-all-offer-section-1').click({
      force: true
    });
    cy.wait(6000);
    cy.go('back');
  ...
  it('Go to property details page by clicking title', function () {
    cy.get('#js-section-2 > .see-more-properties > h2').scrollIntoView();
    cy.get('#js-BC-6358254-details-btn-anchor').click({
      force: true
    });
    cy.wait(2000);
    cy.go('back');
  ...
  it('Click on See more properties of this Best Hotels section', function () {
    ...
    cy.wait(2000);
    cy.get('#see-all-offer-section-2').click({
      force: true
    });
    cy.wait(6000);
    cy.go('back');
  ...
  it('Go to property details page by clicking title', function () {
    cy.get('#js-section-3 > .see-more-properties > h2').scrollIntoView();
    cy.get('#js-BC-76164-details-btn-anchor').click({
      force: true
    });
    cy.wait(2000);
    cy.go('back');
  ...
  it('Click on See more properties of this Cheap Hotels section', function () {
    ...
    cy.wait(2000);
    cy.get('#see-all-offer-section-3').click({
      force: true
    });
    cy.wait(6000);
    cy.go('back');
  ...
  it('Go to property details page by clicking title', function () {
    cy.get('#js-section-4 > .see-more-properties > h2').scrollIntoView();
    cy.get('#js-BC-76269-details-btn-anchor').click({
      force: true
    });
    cy.wait(2000);
    cy.go('back');
  ...
  it('Click on See more properties of this Hotels Nearby section', function () {
    ...
    cy.wait(2000);
    cy.get('#see-all-offer-section-4').click({
      force: true
    });
    cy.wait(6000);
    cy.go('back');
  ...
  it('Go to property details page by clicking title', function () {
    cy.get('#js-section-5 > .see-more-properties > h2').scrollIntoView();
    cy.get('#js-BC-76241-details-btn-anchor').click({
      force: true
    });
    cy.wait(2000);
    cy.go('back');
  ...
  it('Click on See more properties of this Toronto Vacation Rentals section', function () {
    ...
    cy.wait(2000);
    cy.get('#see-all-offer-section-5').click({
      force: true
    });
    cy.wait(6000);
    cy.go('back');
  ...
  it('Go to property details page by clicking title', function () {
    cy.get('#js-section-6 > .see-more-properties > h2').scrollIntoView();
    cy.get('#js-BC-76395-details-btn-anchor').click({
      force: true
    });
    cy.wait(2000);
    cy.go('back');
  ...
  it('Click on See more properties of Pet-Friendly Hotels section', function () {
    ...
    cy.wait(2000);
    cy.get('#see-all-offer-section-6').click({
      force: true
    });
    cy.wait(6000);
    cy.go('back');
  ...
  it('Go to property details page by clicking title', function () {
    cy.get('#js-section-7 > .see-more-properties > h2').scrollIntoView();
    cy.get('#js-BC-29874-details-btn-anchor').click({
      force: true
    });
    cy.wait(2000);
    cy.go('back');
  ...
  it('Click on See more properties of Resorts & All Inclusive Hotels section', function () {
    ...
    cy.wait(2000);
    cy.get('#see-all-offer-section-7').click({
      force: true
    });
    cy.wait(6000);
    cy.go('back');
  ...
  it('Go to property details page by clicking title', function () {
    cy.get('#js-section-8 > .see-more-properties > h2').scrollIntoView();
    cy.get('#js-BC-285745-details-btn-anchor').click({
      force: true
    });
    cy.wait(2000);
    cy.go('back');
  ...
  it('Click on See more properties of Last Minute Deals section', function () {
    ...
    cy.wait(2000);
    cy.get('#see-all-offer-section-8').click({
      force: true
    });
    cy.wait(6000);
    cy.go('back');
  ...
  it('Expand About section by clicking See More', function () {
    ...
    cy.wait(2000);
    cy.get('#js-read-more-sub-page').click({
      force: true
    });
    cy.wait(2000);
  });
  it('Click on the numbers of property count table section', function () {
    ...
    cy.wait(2000);
    cy.get('.js-top-rental-accommodation-table > :nth-child(1) > :nth-child(2) > a').click({
      force: true
    });
    cy.wait(4000);
    cy.go('back');
    cy.get('.col-md-9 > :nth-child(7) > :nth-child(1) > :nth-child(3)').scrollIntoView();
    cy.wait(2000);
    cy.get('.js-top-rental-accommodation-table > :nth-child(2) > :nth-child(2) > a').click({
      force: true
    });
    cy.wait(4000);
    cy.go('back');
    cy.get('.col-md-9 > :nth-child(7) > :nth-child(1) > :nth-child(3)').scrollIntoView();
    cy.wait(2000);
    cy.get('.js-top-rental-accommodation-table > :nth-child(3) > :nth-child(2) > a').click({
      force: true
    });
    cy.wait(4000);
    cy.go('back');
    cy.get('.col-md-9 > :nth-child(7) > :nth-child(1) > :nth-child(3)').scrollIntoView();
    cy.wait(2000);
    cy.get('.js-top-rental-accommodation-table > :nth-child(4) > :nth-child(2) > a').click({
      force: true
    });
    cy.wait(4000);
    cy.go('back');
    cy.get('.col-md-9 > :nth-child(7) > :nth-child(1) > :nth-child(3)').scrollIntoView();
    cy.wait(2000);
    cy.get('.js-top-rental-accommodation-table > :nth-child(5) > :nth-child(2) > a').click({
      force: true
    });
    cy.wait(4000);
    cy.go('back');
  });
  it.only('Find a place from Quick Filters section', function () {
    cy.get('.js-top-rental-accommodation-table > :nth-child(2) > :nth-child(1)').scrollIntoView();
    cy.wait(2000);
    cy.get('.rental-amenities > :nth-child(1) > a').click({
      force: true
    });
    cy.wait(4000);
    cy.go('back');
    cy.get('.js-top-rental-accommodation-table > :nth-child(2) > :nth-child(1)').scrollIntoView();
    cy.wait(2000);
    cy.get('.rental-amenities > :nth-child(3) > a').click({
      force: true
    });
    cy.wait(4000);
    cy.go('back');
    cy.get('.js-top-rental-accommodation-table > :nth-child(2) > :nth-child(1)').scrollIntoView();
    cy.wait(2000);
    cy.get('.rental-amenities > :nth-child(5) > a').click({
      force: true
    });
    cy.wait(4000);
    cy.go('back');
    cy.get('.js-top-rental-accommodation-table > :nth-child(2) > :nth-child(1)').scrollIntoView();
    cy.wait(2000);
    cy.get('.rental-amenities > :nth-child(7) > a').click({
      force: true
    });
    cy.wait(4000);
    cy.go('back');
    cy.get('.js-top-rental-accommodation-table > :nth-child(2) > :nth-child(1)').scrollIntoView();
    cy.wait(2000);
    cy.get('.rental-amenities > :nth-child(9) > a').click({
      force: true
    });
    cy.wait(4000);
    cy.go('back');
    cy.get('.js-top-rental-accommodation-table > :nth-child(2) > :nth-child(1)').scrollIntoView();
    cy.wait(2000);
    cy.get('.rental-amenities > :nth-child(11) > a').click({
      force: true
    });
    cy.wait(4000);
    cy.go('back');
    cy.get('.js-top-rental-accommodation-table > :nth-child(2) > :nth-child(1)').scrollIntoView();
    cy.wait(2000);
    cy.get('.rental-amenities > :nth-child(13) > a').click({
      force: true
    });
    cy.wait(4000);
    cy.go('back');
